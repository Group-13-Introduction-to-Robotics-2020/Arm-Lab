...
def getConfigSpace():
    ...
    #bloated obstacles to make crash_grid
    r=0.49#in radius of bot to bloat obstacles
    b_ob1=np.array([-4-r,4-r,-2+r,6+r])
    b_ob2p1=np.array([-1-r,1-r,0+r,3+r])
    ...
    for lower_angle in lower_theta:
        ...
        for upper_angle in upper_theta:
            ...
            if (x>=b_ob1[0] and x<=b_ob1[2] and y>=b_ob1[1] and y<=b_ob1[3] or
                x>=b_ob2p1[0] and x<=b_ob2p1[2] and y>=b_ob2p1[1] and y<=b_ob2p1[3] or
